...
//tricky: static void *program_break = &end; is not the same as void *program_break = &end;
extern char end;
...
void *_sbrk(intptr_t increment) {
  ...
  //increment is too large (exception)
  intptr_t ret = _syscall_(SYS_brk, (intptr_t)program_break+increment, 0, 0);
  if(ret==-1){
     return (void *)-1;
  }
